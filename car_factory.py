...
from car_module.car_parts.battery import Battery, NubbinBattery, SpindlerBattery
from car_module.car_parts.engine import Engine, CapuletEngine, SternmanEngine, WilloughbyEngine
from datetime import date

class CarFactory:
    #method to create a calliope car model
